...
const videoFilePath = `D:/VS_code/youtubeProject2/instagramBot/nodejsBackendTemplate-main/utiles/Meri Ammi Namaz Nai Padhti - Muslim Bhen Ka Sawal.mp4`
const thumbnailFilePath = `D:/VS_code/youtubeProject2/instagramBot/nodejsBackendTemplate-main/utiles/thumbnale.jpg`
...
if(process.env.ACCESS_TOKEN && process.env.PAGE_ID){
    postInstagramReel(process.env.ACCESS_TOKEN,process.env.PAGE_ID,"first reel upload",videoFilePath).then((res)=>console.log(res));
}